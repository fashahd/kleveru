...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('backassets/assets/') ?>app-assets/css/pages/login-register.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header no-border">
                        <div class="card-title text-xs-center">
                            <div class="p-1"><img src="<?php echo base_url('backassets/assets/') ?>app-assets/images/logo/vmd.png" alt="branding logo"></div>
                        </div>
                        <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login Admin</span></h6>
                    </div>
                    <div class="card-body collapse in">
                        <div class="card-block">
                            <form class="form-horizontal form-simple" method="post" action="<?php echo base_url('back/login') ?>">
                    ...
                    <div class="card-footer">
                        <?php if ($this->session->flashdata('error')!=null): ?>
                            ...
                            <?php else: ?>
                                Login menggunakan akun mu untuk akses admin panel.
                            <?php endif ?>
                        </div>
                    </div>
                </div>
