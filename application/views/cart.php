						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="<?=base_url()?>assets/images/almond8.jpg" alt="IMG">
										</div>
									</td>
									<td class="column-2">Almond </td>
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="<?=base_url()?>assets/images/avocado 3.jpg" alt="IMG">
										</div>
									</td>
									<td class="column-2">Avocado</td>
